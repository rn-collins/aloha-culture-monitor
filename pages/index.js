...
function ContactModal({isOpen,onClose}){
  ...
  return(<>
    ...
    <div role="dialog" aria-modal="true" aria-labelledby="contact-title" style={{position:'fixed',bottom:0,left:0,right:0,background:'white',borderRadius:'16px 16px 0 0',padding:'36px 40px 48px',zIndex:201,maxWidth:560,margin:'0 auto',boxShadow:'0 -8px 40px rgba(0,0,0,0.15)'}}>
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:24}}>
        <div><div id="contact-title" style={{fontFamily:'Syne',fontSize:20,fontWeight:700,color:TX}}>Contact the Architect</div><div style={{fontSize:13,color:MU,marginTop:4}}>RN Collins · Aloha AI Consulting</div></div>
